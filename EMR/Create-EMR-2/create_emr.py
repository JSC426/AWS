...
## TBD: remove the dependency on pandas, which servers no numerical computing purpose in this code
# df_ec2_specs = {
...
def make_spark_config(master_type, slave_type, slave_number):
    ...
    core_per_master_ec2 = df_ec2_specs.loc[master_type].core
    mem_per_master_ec2 = df_ec2_specs.loc[master_type].mem
    core_per_slave_ec2 = df_ec2_specs.loc[slave_type].core
    mem_per_slave_ec2 = df_ec2_specs.loc[slave_type].mem

    # total_core = corenum * core_per_ec2
    # print "Total Cores:",        core_per_master_ec2 + slave_number * core_per_slave_ec2
...
def make_emr_config(master_type, slave_type, slave_number):
    ...
    #     indent=4,
    #     separators=(',', ':'))
    return json.dumps([emrfs_config_dict, spark_config_dict, spark_env_config_dict, yarn_config_dict])
