...
sudo pip3 freeze >> /home/hadoop/bslog.txt

echo "starting of EMR bootstrap, pip-3.6 install pkgs now:" >> /home/hadoop/bslog.txt
date >> /home/hadoop/bslog.txt
sudo pip3 install botocore==1.17.25 --upgrade
sudo pip3 install boto3==1.14.25 --upgrade
sudo pip3 install numpy==1.19.1 --upgrade
sudo pip3 install scipy==1.5.1
sudo pip3 install pandas==1.0.5
sudo pip3 install argparse
sudo pip3 install matplotlib==3.3.0
sudo pip3 install plotly==4.9.0
sudo pip3 install seaborn==0.10.1
sudo pip3 install s3fs==0.4.2
sudo pip3 install scikit-learn==0.23.1
sudo pip3 install findspark==1.4.2
sudo pip3 install py4j==0.10.9
sudo pip3 install grpcio==1.30.0
sudo pip3 install protobuf==3.12.2

# install and configure jupyter
# installing jupyter to /usr/local/bin
sudo pip3 install jupyter==1.0.0
sudo pip3 install jupyterlab==2.2.0

echo "customized pip3 install finished, here is the version:" >> /home/hadoop/bslog.txt
sudo pip3 freeze >> /home/hadoop/bslog.txt
date >> /home/hadoop/bslog.txt
...
sudo pip3 install jupyterlab-git==0.20.0
